...
const CleanupInitiativeRegistration = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-900 to-blue-900 min-h-screen p-8 text-white">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="bg-purple-700 p-4 rounded-lg mb-4">
          <h2 className="text-xl font-semibold">FundingGoal in ETH</h2>
          <input
            className="w-full h-auto p-2 bg-gray-200 text-black rounded"
            placeholder="Describe the pollution..."
            type="number"
            value={fundingGoal}
        ...
        <Web3Button
          ...
          action={async (contract) => {
            ...
            const registrationFee = await contract.call("registrationFee", [])
            console.log(registrationFee);
            console.log("images succesfully uploaded");
            const hell = contract.call("createInitiative", [
              title,
              description,
              fundingGoal,
              imageHashes,
...
export default CleanupInitiativeRegistration;
